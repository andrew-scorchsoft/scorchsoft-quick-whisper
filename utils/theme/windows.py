...
WINDOW_SIZES = {
    ...
    'windows_hd': {
        ...
        'about_dialog': (880, 770),
        'tos_dialog': (340, 170),
        'terms_of_use': (650, 880),
        'manage_prompts': (880, 720),
        'edit_prompt_dialog': (660, 440),
        'config_dialog': (770, 550),
        'hotkey_dialog': (550, 440),
        'adjust_models': (500, 680),
        'version_notification': (440, 220),
    },
    # Linux HiDPI - explicit values
    # Note: Linux Tk scaling may already apply, so these may need to be smaller
    'linux_hd': {
        'main': (1000, 1150),
        'api_key_dialog': (420, 220),
        'about_dialog': (800, 700),
